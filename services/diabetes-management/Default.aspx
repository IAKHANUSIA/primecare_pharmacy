<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Services_DiabetesManagementPage" %>
...
<head runat="server">
    ...
    <title>Diabetes Management - Primecare Pharmacy Windermere Edmonton</title>
    <meta name="description"
        content="Certified Diabetes Management & Support at Primecare Pharmacy, Edmonton. Complete diabetes assistance, blood sugar level control, insulin therapy, and lifestyle solutions." />
...
<body>
    <form id="form1" runat="server">
        ...
        <!-- Service Hero Banner -->
        <section class="service-hero-section" style="background: linear-gradient(135deg, rgba(15, 23, 42, 0.45) 0%, rgba(22, 101, 52, 0.40) 100%), url('../../images/diabetes_blood_test.jpg') center center / cover no-repeat;">
            <div class="service-hero-breadcrumb">Services / Diabetes Management</div>
            <h1 class="service-hero-title">Diabetes Management</h1>
        </section>
        ...
        <main class="service-detail-section">
            <div class="service-detail-grid">
                <div class="service-left-col">
                    <p class="service-lead-text">
                        Diabetes is a chronic disease that occurs when the pancreas is no longer able to make insulin, or when the body cannot make good use of the insulin it produces. When there isn't enough insulin or cells stop responding to insulin, too much blood sugar stays in your bloodstream. Over time, that can cause serious health problems, such as heart disease, vision loss, and kidney disease.
                    </p>
                ...
                <div class="service-right-col">
                    <img src="../../images/diabetes_blood_test.jpg" alt="Blood glucose meter testing for Diabetes Management" class="service-detail-img" />
                </div>
            </div>

            <div class="service-content-body">
                <p>
                    There are three major types of diabetes. Type 2 diabetes is the most common diagnosis, followed by Type 1 diabetes. Gestational diabetes occurs during pregnancy, and is usually temporary.
                </p>
                <p>
                    Type 1 diabetes is caused by an autoimmune reaction where the body's defense system attacks the cells that produce insulin. People with type 1 diabetes need daily injections of insulin to control their blood glucose levels.
                </p>
                <p>
                    Type 2 diabetes is generally characterized by insulin resistance, where the body does not fully respond to insulin. Because insulin cannot work properly, blood glucose levels keep rising, releasing more insulin.
                </p>
                <p>
                    Gestational diabetes is a temporary form of diabetes that occurs during pregnancy. Between three and twenty percent of pregnant women develop gestational diabetes, depending on their risk factors. A diagnosis of gestational diabetes may increase the risk of developing diabetes later in life for both mother and child.
                </p>
            </div>

            <!-- Service Checklist Grid -->
            <div class="service-checklist-card">
                <div class="service-checklist-title">Our diabetes services include the following:</div>
                <div class="service-checklist-grid">
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Complete diabetes assistance</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                    ...
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Blood sugar level control</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Weight management assistance</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Lifestyle suggestions and solutions</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                    ...
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Medication and supplement recommendations</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Diabetes diagnosis, monitoring, and supportive care</span>
                    </div>
                </div>
            </div>
            ...
            <div class="service-cta-banner">
                <h2 class="service-cta-title">Don't let diabetes affect your life. Let us help you deal with the symptoms so you can lead a full life.</h2>
                <p class="service-cta-desc">
                    Get in touch with Primecare Pharmacy now to get the best diabetes management services in town from certified diabetes educators, specialist nurses, and experts.
                </p>
                <button type="button" class="btn-green-pill" onclick="openBookingModal('Diabetes Management');">Book an Appointment</button>
            </div>
        </main>
            ...
            <div class="footer-container">
                ...
                <div class="footer-links-col">
                    ...
                    <ul class="quick-links-grid">
                        ...
                        <li><a href="Default.aspx">Diabetes Management</a></li>
                        <li><a href="../../Default.aspx">Heart Health</a></li>
                        ...
                        <li><a href="../../Default.aspx">Medication Reviews</a></li>
            ...
            <div class="modal-box">
                ...
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="ddlServiceType" runat="server" CssClass="form-control">
                        <asp:ListItem Value="Diabetes Management" Selected="True">Diabetes Management</asp:ListItem>
