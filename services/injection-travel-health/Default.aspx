...
<head runat="server">
    ...
    <title>Injection / Travel Health - Primecare Pharmacy Windermere Edmonton</title>
    <meta name="description"
        content="Travel Vaccine Clinic & Injection Services at Primecare Pharmacy Windermere Plaza, Edmonton. Customized travel immunizations, Yellow Fever, Typhoid, Hepatitis, and expert advice." />
...
<body>
    <form id="form1" runat="server">
        ...
        <!-- Service Hero Banner -->
        <section class="service-hero-section" style="background: linear-gradient(135deg, rgba(15, 23, 42, 0.45) 0%, rgba(22, 101, 52, 0.40) 100%), url('../../images/injection_travel_health.jpg') center center / cover no-repeat;">
            <div class="service-hero-breadcrumb">Services / Injection / Travel Health</div>
            <h1 class="service-hero-title">Injection / Travel Health</h1>
        </section>
        ...
        <main class="service-detail-section">
            <div class="service-detail-grid">
                <div class="service-left-col">
                    <p class="service-lead-text">
                        Injections, also known as shots, deliver liquid medications, fluids, or nutrients directly into a person's body. A healthcare professional can use injections to administer vaccines and other types of medications into a person's vein, muscle, skin, or bone. Several different types of injections exist, depending on the purpose of the medication or substance in the shot.
                    </p>
                ...
                <div class="service-right-col">
                    <img src="../../images/injection_travel_health.jpg" alt="Nurse preparing vaccine injection for Travel Health" class="service-detail-img" />
                </div>
            </div>

            <div class="service-content-body">
                <p>
                    Vaccines protect travelers from serious diseases. Depending on where you travel, you may come into contact with diseases that are rare. Some vaccines may also be required for you to travel to certain places.
                </p>
                <p>
                    Getting vaccinated will help keep you safe and healthy while you're traveling. It will also help make sure that you don't bring any serious diseases home to your family, friends, and community.
                </p>
                <p>
                    At Primecare Pharmacy, a specialist vaccine clinic, you'll receive expert advice tailored to your itinerary and medical needs. We cover vaccines such as Yellow Fever, Malaria, Rabies, Typhoid, Hepatitis A, Hepatitis B, and many more.
                </p>
            </div>

            <!-- Service Checklist Grid -->
            <div class="service-checklist-card">
                <div class="service-checklist-title">What travel vaccinations do you need for my holiday?</div>
                <p style="font-size: 14px; color: #64748b; margin-bottom: 20px;">The specific travel injections you will need depend on such factors as:</p>
                <div class="service-checklist-grid">
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Your age and health</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Which regions you are visiting</span>
                    </div>
                    <div class="service-checklist-item" style="grid-column: span 2;">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>What activities you will be doing</span>
                    </div>
                </div>
            </div>
            ...
            <div class="service-cta-banner">
                <h2 class="service-cta-title">All you have to do is explain how your trip will look like and share your itinerary to receive your customized set of medications and vaccinations from our pharmacy based on your trip. We can provide both medical advice and administer the necessary medication to travelers in one quick stop.</h2>
                <p class="service-cta-desc">
                    Don't let your health issues get in the way of enjoying your vacation or work-related trip. Speak to us to start customizing your travel injections so that you can enjoy your trip while being healthy and staying comfortable throughout.
                </p>
                <button type="button" class="btn-green-pill" onclick="openBookingModal('Injection / Travel Health');">Book Travel Consultation</button>
            </div>
        </main>
            ...
            <div class="footer-container">
                ...
                <div class="footer-links-col">
                    ...
                    <ul class="quick-links-grid">
                        ...
                        <li><a href="../diabetes-management/">Diabetes Management</a></li>
                        <li><a href="../heart-health/">Heart Health</a></li>
                        <li><a href="../../Default.aspx">Home Health Care</a></li>
                        <li><a href="Default.aspx">Injection / Travel Health</a></li>
                        <li><a href="../../Default.aspx">Medication Compounding</a></li>
                        <li><a href="../medication-reviews/">Medication Reviews</a></li>
                        <li><a href="../../Prescriptions.aspx">Prescriptions</a></li>
                        <li><a href="../smoking-cessation-support/">Smoking Cessation Support</a></li>
                        <li><a href="../../Default.aspx">Weight Management</a></li>
                    </ul>
                </div>
                ...
                <div class="form-grid-2col">
                    ...
                    <div class="form-group">
                        ...
                        <asp:DropDownList ID="ddlServiceType" runat="server" CssClass="form-control">
                            <asp:ListItem Value="Injection / Travel Health" Selected="True">Injection / Travel Health</asp:ListItem>
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtBookingNotes" runat="server" TextMode="MultiLine" Rows="1" CssClass="form-control" placeholder="Any specific requirements..."></asp:TextBox>
                    </div>
                </div>

                <asp:Button ID="btnSubmitBooking" runat="server" Text="Submit Booking" OnClick="btnSubmitBooking_Click" CssClass="btn-green-pill" style="width: 100%; border-radius: 8px; margin-top: 8px;" />
            </div>
        </div>
        ...
        <div id="prescriptionModal" class="modal-overlay">
            <div class="modal-box">
                ...
                <div class="form-grid-2col">
                    ...
                    <div class="form-group">
                        <label class="form-label">Rx # / Previous Pharmacy</label>
                        <asp:TextBox ID="txtRxNumber" runat="server" CssClass="form-control" placeholder="Rx # or Pharmacy"></asp:TextBox>
                    </div>

                    <div class="form-group full-width">
                        <label class="form-label">Notes / Medication List</label>
                        <asp:TextBox ID="txtRxNotes" runat="server" TextMode="MultiLine" Rows="1" CssClass="form-control" placeholder="List medications to refill or transfer details..."></asp:TextBox>
                    </div>
                </div>

                <asp:Button ID="btnSubmitPrescription" runat="server" Text="Submit Prescription Request" OnClick="btnSubmitPrescription_Click" CssClass="btn-green-pill" style="width: 100%; border-radius: 8px; margin-top: 8px;" />
            </div>
        </div>
