<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Services_WeightManagementPage" %>
...
<head runat="server">
    ...
    <title>Weight Management - Primecare Pharmacy Windermere Edmonton</title>
    <meta name="description"
        content="Customized Weight Management Programs at Primecare Pharmacy Windermere Plaza, Edmonton. Comprehensive health & dietary assessments, specialist advice, and safe lifestyle solutions." />
...
<body>
    <form id="form1" runat="server">
        ...
        <!-- Service Hero Banner -->
        <section class="service-hero-section" style="background: linear-gradient(135deg, rgba(15, 23, 42, 0.45) 0%, rgba(22, 101, 52, 0.40) 100%), url('../../images/weight_management.jpg') center center / cover no-repeat;">
            <div class="service-hero-breadcrumb">Services / Weight Management</div>
            <h1 class="service-hero-title">Weight Management</h1>
        </section>
        ...
        <main class="service-detail-section">
            <div class="service-detail-grid">
                <div class="service-left-col">
                    <p class="service-lead-text">
                        Weight management refers to a set of practices and behaviors that are necessary to keep one's weight at a healthful level. The purpose of weight management is to help each person to achieve and stay at the best weight possible in the context of overall health, occupation, and living situation.
                    </p>

                    <div class="service-callout-box">
                        Get in your best shape safely and efficiently with individualized weight management programs.
                    </div>
                </div>

                <div class="service-right-col">
                    <img src="../../images/weight_management.jpg" alt="Nutritionist measuring waist for Weight Management" class="service-detail-img" />
                </div>
            </div>

            <div class="service-content-body">
                <p>
                    Healthy bodies come in many shapes and sizes. A healthy weight is one that contributes to your overall health, wellbeing, and quality of life. It is different for each person. A healthy weight is a weight that lowers your risk for health problems. But reaching a healthy weight isn't just about reaching a certain number on the scale or a certain BMI. Having healthy eating and exercise habits is very important.
                </p>
                <p>
                ...
                <p>
                    Primecare Pharmacy can help you easily avoid such risks by helping you manage your weight in a safe environment. We focus on a healthy lifestyle, combining healthy foods and exercise. We offer customized weight management solutions to you based on your expectations, lifestyle, age, fitness levels, among other factors. We are a team of experienced professionals that can guide you through the process of weight management.
                </p>
            </div>

            <!-- Service Checklist Grid -->
            <div class="service-checklist-card">
                <div class="service-checklist-title">You can expect the following from us:</div>
                <div class="service-checklist-grid">
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Comprehensive assessment of your health and lifestyle</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Clinical diagnosis of your health as applicable</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                    ...
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Psychological and social assessment as required</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Specialist advice and education on diet and lifestyle modifications</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Medical or surgical suggestions if required</span>
                    </div>
                </div>
            </div>
            ...
            <div class="service-cta-banner">
                <h2 class="service-cta-title">Don't let your weight get in the way of your life. Let us help you get in the right shape so you can lead a healthy life.</h2>
                <p class="service-cta-desc">
                    We offer specific, measurable, achievable, realistic, and timely weight management solutions in the city at the best prices. Reach out to us now to know more about our weight management services.
                </p>
                <button type="button" class="btn-green-pill" onclick="openBookingModal('Weight Management');">Book Weight Consultation</button>
            </div>
        </main>
            ...
            <div class="modal-box">
                ...
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="ddlServiceType" runat="server" CssClass="form-control">
                        <asp:ListItem Value="Weight Management" Selected="True">Weight Management</asp:ListItem>
