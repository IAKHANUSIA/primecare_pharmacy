<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Services_SmokingCessationSupportPage" %>
...
<head runat="server">
    ...
    <title>Smoking Cessation Support - Primecare Pharmacy Windermere Edmonton</title>
    <meta name="description"
        content="Personalized Smoking Cessation Support & Counselling at Primecare Pharmacy Windermere Plaza, Edmonton. Over-the-counter recommendations, withdrawal management, and nicotine replacement therapy." />
...
<body>
    <form id="form1" runat="server">
        ...
        <!-- Service Hero Banner -->
        <section class="service-hero-section" style="background: linear-gradient(135deg, rgba(15, 23, 42, 0.45) 0%, rgba(22, 101, 52, 0.40) 100%), url('../../images/smoking_cessation.jpg') center center / cover no-repeat;">
            <div class="service-hero-breadcrumb">Services / Smoking Cessation Support</div>
            <h1 class="service-hero-title">Smoking Cessation Support</h1>
        </section>
        ...
        <main class="service-detail-section">
            <div class="service-detail-grid">
                <div class="service-left-col">
                    <p class="service-lead-text">
                        The multiple, often catastrophic, adverse effects of smoking are well known. In most cases, helping patients to quit smoking will be the single most effective health intervention that a pharmacist can provide.
                    </p>
                ...
                <div class="service-right-col">
                    <img src="../../images/smoking_cessation.jpg" alt="Smoking Cessation Concept Photography" class="service-detail-img" />
                </div>
            </div>

            <div class="service-content-body">
                <p>
                    Is it too late to quit? It's never too late! In fact, people of all ages experience immediate and long-term health benefits from quitting smoking. People who have smoked for many years just as those who started more recently can reap the health and financial benefits of quitting. Even those who have developed smoking-related problems like heart disease or cancer can benefit from quitting.
                </p>
                <p>
                    Primecare Pharmacy is here to help you quit smoking the right way with our support and advice. Our smoking cessation support includes many things, from group counselling and 1-on-1 sessions to 1-on-1 advice, along with medications for severe cigarette addiction. We can also help you deal with the withdrawal symptoms with nicotine chewing gums, nicotine patches, nicotine inhalers, and sprays, etc.
                </p>
            </div>

            <!-- Service Checklist Grid -->
            <div class="service-checklist-card">
                <div class="service-checklist-title">You can expect the following things from our smoking cessation support:</div>
                <div class="service-checklist-grid">
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Over-the-counter product recommendations to help you quit smoking</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Planned preparation for nicotine withdrawal and craving with the right support</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Individualized action plan and counselling sessions to help ease the transition</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Motivational coaching support with regular follow-up and monitoring sessions</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Support to help you make healthier lifestyle, dietary, and physical choices</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Advice on coping with the stress and options for dealing with relapse</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Collaborative support from healthcare providers to ensure a comprehensive approach to smoking cessation</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Support network and resource recommendations to help you reach your goals</span>
                    </div>
                </div>
            </div>
            ...
            <div class="service-cta-banner">
                <h2 class="service-cta-title">Become tobacco-free with individualized support and advice. Let us help you quit smoking.</h2>
                <p class="service-cta-desc">
                    Quitting smoking is challenging, but it does not have to be impossible. Let Primecare Pharmacy's kit help you quit smoking. Contact us to know more.
                </p>
                <button type="button" class="btn-green-pill" onclick="openBookingModal('Smoking Cessation Support');">Book Consultation</button>
            </div>
        </main>
            ...
            <div class="footer-container">
                ...
                <div class="footer-links-col">
                    ...
                    <ul class="quick-links-grid">
                        ...
                        <li><a href="Default.aspx">Smoking Cessation Support</a></li>
            ...
            <div class="modal-box">
                ...
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="ddlServiceType" runat="server" CssClass="form-control">
                        <asp:ListItem Value="Smoking Cessation Support" Selected="True">Smoking Cessation Support</asp:ListItem>
                ...
                <asp:Button ID="btnSubmitBooking" runat="server" Text="Submit Booking" CssClass="btn-green-pill" style="width: 100%; border-radius: 8px;" />
            </div>
        </div>
        ...
        <div id="prescriptionModal" class="modal-overlay">
            <div class="modal-box">
                ...
                <asp:Button ID="btnSubmitPrescription" runat="server" Text="Submit Prescription Request" CssClass="btn-green-pill" style="width: 100%; border-radius: 8px;" />
            </div>
        </div>
