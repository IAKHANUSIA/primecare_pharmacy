...
Partial Public Class Services_PrescriptionsPage
    ...
    Protected Sub btnSubmitBooking_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSubmitBooking.Click
        Try
            ...
            Dim serviceType As String = If(ddlServiceType IsNot Nothing, ddlServiceType.SelectedValue, "Prescriptions")
            Dim preferredDate As String = txtBookingDate.Text.Trim()
            Dim notes As String = txtBookingNotes.Text.Trim()

            If String.IsNullOrWhiteSpace(fullName) OrElse String.IsNullOrWhiteSpace(phone) Then
                pnlMessage.CssClass = "alert alert-danger"
                lblStatusMessage.Text = "Please provide your Full Name and Phone Number."
    ...
    Protected Sub btnSubmitPrescription_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSubmitPrescription.Click
        Try
            ...
            SaveBookingLocally("Prescription Refill/Transfer", fullName, phone, email, "Prescriptions", rxNumber, "", notes)
            SaveBookingToAccessDB("Prescription Refill/Transfer", fullName, phone, email, "Prescriptions", rxNumber, "", notes)
