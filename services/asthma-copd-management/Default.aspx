<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Services_AsthmaCopdManagementPage"
    ...
    <head runat="server">
        ...
        <title>Asthma/COPD Management - Primecare Pharmacy Windermere Edmonton</title>
        <meta name="description"
            content="Expert Asthma & COPD Management Services at Primecare Pharmacy, Edmonton. Inhaler guidance, pulmonary support, and symptom control." />
    ...
    <body>
        ...
        <header class="header-container">
            ...
            <section class="service-hero-section"
                style="background: linear-gradient(135deg, rgba(15, 23, 42, 0.45) 0%, rgba(22, 101, 52, 0.40) 100%), url('../../images/asthma_copd_management.jpg') center center / cover no-repeat;">
                <div class="service-hero-breadcrumb">Services / Asthma/COPD Management</div>
                <h1 class="service-hero-title">Asthma/copd Management</h1>
            </section>
            ...
            <main class="service-detail-section">
                <div class="service-detail-grid">
                    <div class="service-left-col">
                        <p class="service-lead-text">
                            Asthma and COPD (Chronic Obstructive Pulmonary Disease) are obstructive pulmonary diseases
                            that affect millions of people all over the world. Asthma can be diagnosed at any time in
                            one's life. Having COPD for a long time may change the way your lungs work. Early diagnosis
                            can be crucial to preserving lung function in people.
                        </p>

                        <div class="service-callout-box">
                            Learn how to deal with asthma or COPD under the guidance of expert healthcare professionals
                            and pharmacists.
                        </div>
                    </div>

                    <div class="service-right-col">
                        <img src="../../images/asthma_copd_management.jpg"
                            alt="Child using nebulizer inhaler with mother for Asthma/COPD Management"
                ...
                <div class="service-content-body">
                    <p>
                        Chronic obstructive pulmonary disease (COPD) is a collection of lung diseases that cause
                        breathing problems and obstruct airflow. Asthma is considered severe when it is difficult to
                        treat and manage the symptoms. Resources are available to help you ask the right questions about
                        asthma management and treatment. Both COPD and asthma respond well to treatments like quitting
                        smoking and airway-opening medications like bronchodilators.
                    </p>
                    <p>
                        Today asthma and COPD are not fully curable, not identified enough and not treated enough and
                        the therapy is still developing. If you want to control your asthma or COPD, Primecare Pharmacy
                        can help you with our asthma and COPD management services. No matter how big or small your
                        symptoms are, we provide you with all the right support.
                    </p>
                </div>

                <!-- Service Checklist Grid -->
                <div class="service-checklist-card">
                    <div class="service-checklist-title">You can expect the following from our asthma and COPD
                        management:</div>
                    <div class="service-checklist-grid">
                        ...
                        <div class="service-checklist-item">
                            <span class="service-checklist-icon">&rsaquo;</span>
                            <span>Guidance on using inhalers, nebulizers, and tablets</span>
                        </div>
                        <div class="service-checklist-item">
                            <span class="service-checklist-icon">&rsaquo;</span>
                            <span>Pulmonary rehabilitation, a specialized program of exercise and education</span>
                        </div>
                        <div class="service-checklist-item">
                            <span class="service-checklist-icon">&rsaquo;</span>
                            <span>Non-invasive ventilation (NIV) treatment</span>
                        </div>
                        <div class="service-checklist-item">
                            <span class="service-checklist-icon">&rsaquo;</span>
                            <span>Surgery or lung transplantation</span>
                        </div>
                        <div class="service-checklist-item">
                            <span class="service-checklist-icon">&rsaquo;</span>
                            <span>High-end medication and long-term invasive procedure guidance and support</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="service-cta-banner">
                    <h2 class="service-cta-title">Don't let asthma or COPD hamper your lifestyle, and control their
                        progression and symptoms. Let us help you.</h2>
                    <p class="service-cta-desc">
                        We understand that managing asthma or COPD is not just about filling a prescription. So, we
                        check in with you to ensure you have all the information and resources you need to feel
                        confident and in-control of your condition. Contact Primecare Pharmacy to know more.
                    </p>
                    <button type="button" class="btn-green-pill"
                        onclick="openBookingModal('Asthma/COPD Management');">Book Consultation</button>
                </div>
            </main>
                ...
                <div class="footer-container">
                    <div class="footer-brand-col">
                        ...
                        <p class="footer-about-text">
                            Independently owned pharmacy serving Windermere & Edmonton with medication safety,
                            prescriptions, and healthcare excellence.
                        </p>
                    </div>
                    ...
                    <div class="footer-links-col">
                        ...
                        <ul class="quick-links-grid">
                            ...
                            <li><a href="Default.aspx">Asthma/COPD Management</a></li>
                            <li><a href="../diabetes-management/">Diabetes Management</a></li>
                            <li><a href="../heart-health/">Heart Health</a></li>
                        ...
                        <ul class="contact-info-list">
                            ...
                            <li>
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                    class="contact-icon">
                                    <path d="M18 8H6a2 2 0 0 0-2 2v7a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-7a2 2 0 0 0-2-2z">
                                    </path>
            ...
            <div id="bookingModal" class="modal-overlay">
                <div class="modal-box">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtBookingEmail" runat="server" TextMode="Email" CssClass="form-control"
                            placeholder="sarah@example.com"></asp:TextBox>
                    </div>

                    <div class="form-group">
                        <label class="form-label">Select Service *</label>
                        <asp:DropDownList ID="ddlServiceType" runat="server" CssClass="form-control">
                            <asp:ListItem Value="Asthma/COPD Management" Selected="True">Asthma/COPD Management
                            </asp:ListItem>
                            <asp:ListItem Value="Diabetes Management">Diabetes Management</asp:ListItem>
                            <asp:ListItem Value="Flu Shot & Covid-19 Vaccination">Flu Shot & Covid-19 Vaccination
                            </asp:ListItem>
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtBookingNotes" runat="server" TextMode="MultiLine" Rows="2"
            ...
            <div id="prescriptionModal" class="modal-overlay">
                <div class="modal-box">
                    ...
                    <div class="form-group">
                        <label class="form-label">Phone Number *</label>
                        <asp:TextBox ID="txtRxPhone" runat="server" CssClass="form-control" placeholder="Phone Number">
                        </asp:TextBox>
                    </div>
