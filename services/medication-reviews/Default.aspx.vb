...
Partial Public Class Services_MedicationReviewsPage
    Inherits Page
    ...
    Protected Sub btnSubmitBooking_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSubmitBooking.Click
        Try
            ...
            Dim serviceType As String = If(ddlServiceType IsNot Nothing, ddlServiceType.SelectedValue, "Medication Reviews")
