...
<head runat="server">
    ...
    <title>Medication Reviews - Primecare Pharmacy Windermere Edmonton</title>
    <meta name="description"
        content="Comprehensive Medication Reviews & Management at Primecare Pharmacy Windermere Plaza, Edmonton. Safety checks, side effect prevention, and personalized consultation." />
...
<body>
    <form id="form1" runat="server">
        ...
        <!-- Service Hero Banner -->
        <section class="service-hero-section" style="background: linear-gradient(135deg, rgba(15, 23, 42, 0.45) 0%, rgba(22, 101, 52, 0.40) 100%), url('../../images/medication_reviews.jpg') center center / cover no-repeat;">
            <div class="service-hero-breadcrumb">Services / Medication Reviews</div>
            <h1 class="service-hero-title">Medication Reviews</h1>
        </section>
        ...
        <main class="service-detail-section">
            <div class="service-detail-grid">
                ...
                <div class="service-right-col">
                    <img src="../../images/medication_reviews.jpg" alt="Medication bottle with amber capsules for Medication Reviews" class="service-detail-img" />
                </div>
            </div>

            <div class="service-content-body">
                <p>
                    Medications are drugs manufactured to help people deal with a range of health issues. We use medications to relieve symptoms of medical conditions, to combat both short-term and chronic illness, and to manage our daily lives.
                </p>
                <p>
                    There are always risks to taking medicines. It is important to think about these risks before you take medicine. Even safe medicines can cause unwanted side effects or interactions with food, alcohol, or other medicines you may be taking. Some medicines may not be safe during pregnancy.
                </p>
                <p>
                    Taking medications incorrectly can have severe consequences on the body's health in the long run. If you take regular medications, you need to make sure you are taking your medicines as prescribed correctly, and Primecare Pharmacy can help you with it. We also provide comprehensive medication management services, so you never miss any medications, prevent drug interactions, and don't get side effects.
                </p>
            </div>

            <!-- Service Checklist Grid -->
            <div class="service-checklist-card">
                <div class="service-checklist-title">We cover the following under our medication management and reviews:</div>
                <div class="service-checklist-grid">
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>The purpose of medication review</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Any potential reactions to other medications</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Side effects that you may experience</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Ease of use and swallowing</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Techniques on how to use the medications</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Symptoms that the medication may not control</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Best time to take the medication</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Potential problems such as drug interactions or contraindications</span>
                    </div>
                    <div class="service-checklist-item" style="grid-column: span 2;">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Any other queries you may have about your medications</span>
                    </div>
                </div>
            </div>
            ...
            <div class="service-cta-banner">
                <h2 class="service-cta-title">Know everything about your medications and get the best results by taking them correctly with us.</h2>
                <p class="service-cta-desc">
                    Primecare Pharmacy is a pharmacy with prescribing authority. We offer the best medication review and management services in the city, along with free delivery and compounding services. Get the best out of your regular medications by getting in touch with us.
                </p>
                <button type="button" class="btn-green-pill" onclick="openBookingModal('Medication Reviews');">Book a Medication Review</button>
            </div>
        </main>
            ...
            <div class="modal-box">
                ...
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="ddlServiceType" runat="server" CssClass="form-control">
                        <asp:ListItem Value="Medication Reviews" Selected="True">Medication Reviews</asp:ListItem>
