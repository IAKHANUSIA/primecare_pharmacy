<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Services_HeartHealthPage" %>
...
<head runat="server">
    ...
    <title>Heart Health - Primecare Pharmacy Windermere Edmonton</title>
    <meta name="description"
        content="Heart Health & Cardiovascular Wellness Services at Primecare Pharmacy Windermere Plaza, Edmonton. Blood pressure monitoring, cholesterol advice, eating plans, and risk assessment." />
...
<body>
    <form id="form1" runat="server">
        ...
        <!-- Service Hero Banner -->
        <section class="service-hero-section" style="background: linear-gradient(135deg, rgba(15, 23, 42, 0.45) 0%, rgba(22, 101, 52, 0.40) 100%), url('../../images/heart_health.jpg') center center / cover no-repeat;">
            <div class="service-hero-breadcrumb">Services / Heart Health</div>
            <h1 class="service-hero-title">Heart Health</h1>
        </section>
        ...
        <main class="service-detail-section">
            <div class="service-detail-grid">
                <div class="service-left-col">
                    <p class="service-lead-text">
                        Heart disease is a leading cause of death in Canada for both men and women. But you can do a lot to protect your heart and stay healthy. Heart-healthy living involves understanding your risk, making healthy choices, and taking steps to reduce your chances of getting heart disease.
                    </p>

                    <div class="service-callout-box">
                        Your heart is vulnerable. Protect it with the right kind of lifestyle and healthcare support.
                    </div>
                </div>

                <div class="service-right-col">
                    <img src="../../images/heart_health.jpg" alt="Medical professional with red heart symbol for Heart Health" class="service-detail-img" />
                </div>
            </div>

            <div class="service-content-body">
                <p>
                    Heart disease accounts for nearly one-third of all deaths worldwide. The cardiovascular system relates to your heart and the blood vessels that move blood around your body. The blood pumped through your heart supplies vital oxygen and nutrients throughout your body. Leading a healthy lifestyle is important for your heart health. This includes maintaining a healthy diet and exercising. By taking preventive measures, you can lower your risk of developing heart disease that could lead to a heart attack.
                </p>
                <p>
                    The heart's health is crucial, and you must take care of it, and Primecare Pharmacy can help you with it. We are a team of healthcare professionals and heart health experts that can help you protect your health from health conditions. Apart from diagnosis and treatment, we even offer healthcare services to help cardiac patients. We can even review your medical history and develop a risk assessment report.
                </p>
            </div>

            <!-- Service Checklist Grid -->
            <div class="service-checklist-card">
                <div class="service-checklist-title">Our heart health recommendations include the following:</div>
                <div class="service-checklist-grid">
                    ...
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Blood sugar and diabetes management</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                    ...
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Individualized eating plan</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
                        <span>Smoking cessation advice</span>
                    </div>
                    <div class="service-checklist-item">
                        <span class="service-checklist-icon">&rsaquo;</span>
            ...
            <div class="service-cta-banner">
                <h2 class="service-cta-title">Don't let heart conditions slow you down or risk your life. Let us help you take care of your heart and control your health.</h2>
                <p class="service-cta-desc">
                    Your heart is vulnerable due to the modern lifestyle, but there's a lot you can do to safeguard your heart health and prevent it from heart conditions. Similarly, you can slow down and control the heart condition symptoms using the right approach. Get in touch with Primecare Pharmacy to know more about our heart health services.
                </p>
                <button type="button" class="btn-green-pill" onclick="openBookingModal('Heart Health');">Book Heart Health Consultation</button>
            </div>
        </main>
            ...
            <div class="modal-box">
                ...
                <div class="form-group">
                    ...
                    <asp:DropDownList ID="ddlServiceType" runat="server" CssClass="form-control">
                        <asp:ListItem Value="Heart Health" Selected="True">Heart Health</asp:ListItem>
