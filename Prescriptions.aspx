...
<head runat="server">
    ...
    <meta name="description" content="Prescription services approved by Health Canada. Primecare Pharmacy in Windermere Plaza, Edmonton provides fast, safe prescription refills and transfers." />
    ...
    <style>
        /* Dedicated Page Styles for Prescriptions Page */
        .prescriptions-hero {
            position: relative;
            height: 220px;
            background: linear-gradient(135deg, rgba(15, 23, 42, 0.45) 0%, rgba(22, 101, 52, 0.40) 100%), url('images/prescriptions_apothecary.jpg') center center / cover no-repeat;
            display: flex;
            align-items: center;
        ...
        .green-accent-callout-box {
            border-left: 4px solid #1ea84c;
...
<body>
    <form id="form1" runat="server">
        ...
        <!-- Prescriptions Hero Banner -->
        <section class="prescriptions-hero">
            <h1>Prescriptions</h1>
        </section>

        <!-- Main Prescriptions Page Content -->
        <main class="prescriptions-page-container">
            <div class="prescriptions-top-grid">
                <!-- Left Column -->
                <div>
                    <p class="prescriptions-intro-text">
                    ...
                    <div class="green-accent-callout-box">
                        Get the right prescriptions for your medications using the best prescribing services in the city.
                    </div>
                </div>

                <!-- Right Column: Compounding Photo -->
                <div>
                    <img src="images/prescription_compounding.jpg" alt="Pharmacist preparing prescription medicines" class="compounding-img" />
                </div>
            </div>

            <!-- Detailed Explanation Text -->
            <p class="prescriptions-body-p">
            ...
            <div class="prescriptions-category-title">
                You can expect to buy the following medicines from our clinic:
            </div>

            <div class="category-list-box">
                <div class="category-list-grid">
                    <div>
                        <div class="category-item">Antibiotics</div>
                        <div class="category-item" style="margin-top:12px;">Anti-inflammatories and painkillers</div>
                        <div class="category-item" style="margin-top:12px;">Basic ointments</div>
                        <div class="category-item" style="margin-top:12px;">Asthma inhalers</div>
                        <div class="category-item" style="margin-top:12px;">Antiemetics</div>
                    </div>
                    <div>
                        <div class="category-item">Antidepressants</div>
                        <div class="category-item" style="margin-top:12px;">Antihistamines</div>
                        <div class="category-item" style="margin-top:12px;">Nasal sprays</div>
                        <div class="category-item" style="margin-top:12px;">Eye and ear drops</div>
                        <div class="category-item" style="margin-top:12px;">Contraceptives</div>
                    </div>
                </div>
            </div>

            <!-- Bottom Green Callout -->
            <div class="bottom-green-heading">
                Let us help you take the right medications for your conditions using our prescription service approved by Health Canada.
            </div>

            <p class="bottom-callout-p">
